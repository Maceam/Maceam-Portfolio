...
class BuildersCradle(BuildersCradleTemplate):
  ...
  def RepeatC2C(self, **event_args):
    ...
    for Name in FolioWork:
      img = Image(source= Name['PortImg'], horizontal_align= "center", role= "faded", visible= True, display_mode="fill_width", vertical_align= "center")
      C2CFlowPanel.add_component(img, width= 800)