...
def PanelReset(self, panel_name):
  ReAdd= Portfolio() 
  get_open_form().content_panel.clear()
  get_open_form().content_panel.add_component(panel_name)
...
class Portfolio(PortfolioTemplate):
  ...
  def C2CButton(self, **event_args):
    ButtonExp= Button(text= "The Builder's Cradle", align= "full", font_size= 22, spacing_above= "none", spacing_below= "none")
  ...
  def C2CButton_click(self, **event_args):
    ...
    PanelReset(self, BuildersCradleForm)
